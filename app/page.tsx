  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 text-white px-4 sm:px-6 max-w-3xl mx-auto py-16 sm:py-0">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 drop-shadow-lg text-gray-100 font-light">
                ...
                <div className="relative rounded-xl overflow-hidden h-full" style={{backgroundColor: '#252525'}}>
                  ...
                  <div className="h-32 sm:h-40 flex flex-col justify-center items-center bg-linear-to-br from-gray-700 to-gray-800 p-4 sm:p-6 text-center group-hover:bg-gray-700 transition" style={{backgroundImage: 'linear-gradient(135deg, #2a2a2a 0%, #1a1a1a 100%)'}}>
                    <img
                      ...
                      className="object-contain mb-2 group-hover:scale-110 transition w-12 h-12 sm:w-16 sm:h-16"
                    />
                  </div>

                  {/* Info siempre visible + overlay */}
                  <div className="p-4 sm:p-6 group-hover:bg-gray-700 transition space-y-2" style={{backgroundColor: '#252525'}}>
